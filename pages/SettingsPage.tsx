        ...
        <div className="space-y-4">
          <ul className="space-y-3">
            {competitors.map((competitor, index) => (
              <li
                key={index}
                className="flex justify-between items-center bg-gray-500/10 p-3 rounded-lg"
              >
                ...
                <div className="flex items-center">
                  <span className="text-gray-400 mr-3 hidden sm:inline">
                    Score:
                  </span>
          ...
          <div className="grid sm:grid-cols-[1fr_auto_auto] gap-2 pt-4 border-t border-white/10">
            ...
            <Button
              ...
              disabled={!newCompetitorName.trim() || !newCompetitorScore.trim()}
            >
              Add
            </Button>
          </div>
      ...
      <Card>
        <div className="space-y-4">
          ...
          <ToggleSwitch
            ...
            onChange={() => handlePlatformToggle('gemini')}
          />
          <ToggleSwitch
            label="OpenAI ChatGPT"
            enabled={platforms.chatgpt}
            onChange={() => handlePlatformToggle('chatgpt')}
          />
          <ToggleSwitch
            label="Anthropic Claude"
            enabled={platforms.claude}
            onChange={() => handlePlatformToggle('claude')}
          />
        </div>
      </Card>
