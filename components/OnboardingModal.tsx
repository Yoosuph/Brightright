...
const OnboardingModal: React.FC<OnboardingModalProps> = ({
        ...
        return (
          <div className="text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              Let's get your dashboard set up in a few seconds.
            </p>
            <Button
              onClick={() => setStep(2)}
              variant="primary"
        ...
        return (
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6 text-center text-sm">
              Optional: Add competitors to see how you stack up. You can change
              this later.
            </p>
            ...
            <div className="space-y-4">
              <ul className="space-y-2 max-h-32 overflow-y-auto pr-2">
                {competitors.map((competitor, index) => (
                  <li
                    key={index}
                    className="flex justify-between items-center bg-gray-500/10 p-2 rounded-lg animate-fade-in"
                  >
                    <span className="font-medium">{competitor.name}</span>
                    <div className="flex items-center">
                      <span className="font-bold text-brand-purple mr-3">
              ...
              <div className="grid grid-cols-[1fr_auto_auto] gap-2 pt-4 border-t border-white/10">
                ...
                <Button
                  ...
                  disabled={
                    !newCompetitorName.trim() || !newCompetitorScore.trim()
                  }
                >
                  Add
                </Button>
          ...
          <div>
            <div className="text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm">
                Please confirm the details below before we build your dashboard.
              </p>
            </div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {keywords
                    ...
                    .map(keyword => (
                      <span
                        key={keyword}
                        className="bg-brand-purple/20 text-brand-purple/90 text-xs font-medium px-2.5 py-1 rounded-full"
                      >
                        {keyword}
                      </span>
                    ))}
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-lg ${isExiting ? 'animate-slide-down' : 'animate-slide-up'}`}
      >
